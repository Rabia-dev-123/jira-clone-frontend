...
const Login = ({ setNotification }) => {
  ...
  // In Login.js - handleSubmit function, after successful login:
  ...
  return (
    <div className="auth-container">
      <div className="auth-card">
        {/* ... (rest of your login UI remains same) ... */}
        
        <h2>Log in to continue</h2>

        {error && <p className="auth-error" style={{color: "#DE350B"}}>{error}</p>}
